...
1. RUN THE INSTALLER
   ...
   - If you see "Windows protected your PC":
       a. Click "More info".
       b. Click "Run anyway".
   - Follow the installer (you can choose the install folder). It creates
...
WHY THIS WARNING?
   Microsoft SmartScreen flags apps that aren't signed with a paid certificate.
   Signing costs money; this project stays free by shipping unsigned. The source
   code is public if you'd rather build it yourself.
